    ...
    >
      <div className="mx-auto max-w-4xl w-full">
          ...
          <div className="flex items-center gap-1 sm:gap-3 min-h-[200px] sm:min-h-[250px]">
            <button
              onClick={() => paginate(-1)}
              className="shrink-0 p-2 rounded-full text-[var(--color-text-muted)] hover:text-[var(--color-navbar-text)] hover:bg-[var(--color-text-muted)] transition-colors"
            ...
            <div className="flex-1 min-w-0 overflow-hidden relative min-h-[200px]">
              <AnimatePresence mode="wait" custom={direction}>
                ...
                >
                  <h3 className="text-lg font-semibold tracking-tight text-[var(--color-text-muted)] mb-5 text-center">
                    {category}
                  </h3>
