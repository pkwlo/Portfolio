    ...
    >
      <div className="mx-auto max-w-4xl w-full">
        ...
        <div className="space-y-4 max-w-2xl">
          ...
          <p className="text-[var(--color-text-muted)] leading-relaxed">
            I'm currently in the early stages of development on a game called Apothecary Understudy! You can see my progress on my <Link to="/blog" className="text-[var(--color-accent)] hover:underline">dev blog</Link>.
          </p>
        </div>
        </div>
      </div>
